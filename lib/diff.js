...
try {
  ...
  function makeDiff(expected, actual, inline) {
    ...
    return inline
      ? textDiff.diffWordsWithSpace(expected, patched)
      : textDiff.structuredPatch(null, null, expected, patched);
  }

  module.exports = function diff(inline) {
    return makeDiff(this.expected, this.actual, inline);
  };
} catch (e) {
